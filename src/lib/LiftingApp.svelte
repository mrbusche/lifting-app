<script>
  ...
  // The problematic reactive block that caused the cyclical dependency has been removed.
  // Instead, repsCompleted is now initialized/reset within the functions that modify exercise state.
